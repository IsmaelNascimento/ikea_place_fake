...
public class ARFocusSquareAltered : MonoBehaviour
{
    public Vector3 OnFoundPlanePosition { get; set; }
    public Quaternion OnFoundPlaneRotation { get; set; }
    public bool OnFoundPlane { get; set; }
    ...
    public FocusState SquareState
    {
        ...
        set
        {
            ...
            OnFoundPlane = squareState == FocusState.Found ? true : false;
    ...
    void Update()
    {
        ...
        if (Physics.Raycast(ray, out hit, maxRayDistance, collisionLayerMask))
        {
            ...
            OnFoundPlanePosition = hit.point;
            //Debug.Log(string.Format("foundSquare position :: x:{0:0.######} y:{1:0.######} z:{2:0.######}", foundSquare.transform.position.x, foundSquare.transform.position.y, foundSquare.transform.position.z));

            //and the rotation from the transform of the plane collider
            SquareState = FocusState.Found;
            foundSquare.transform.rotation = hit.transform.rotation;
            OnFoundPlaneRotation = hit.transform.rotation;
            //Debug.Log(string.Format("foundSquare rotation :: x:{0:0.######} y:{1:0.######} z:{2:0.######}", foundSquare.transform.rotation.x, foundSquare.transform.rotation.y, foundSquare.transform.rotation.z));
